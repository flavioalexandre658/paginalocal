...
export const metadata: Metadata = {
  title: 'Sobre a Decolou | Sites Profissionais para Negócios Locais',
  description: 'Conheça a Decolou: nós ajudamos negócios locais a ter sites otimizados para aparecer no topo do Google e converter clientes pelo WhatsApp.',
}
