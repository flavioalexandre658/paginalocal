...
export const SERVICE_PAGE_BY_MODE: Partial<Record<StoreMode, ModeCopy>> = {
    LOCAL_BUSINESS: {
        ...
        "service.ctaPhone": [
            ...
            ({ name }) => [{ t: "text", v: `Chamar ${name} por telefone` }],
            () => [{ t: "text", v: `Ligar e tirar dúvidas` }],
    ...
    PRODUCT_CATALOG: {
        ...
        "service.ctaPhone": [
            ({ name }) => [{ t: "text", v: `Ligar para ${name}` }],
            ({ name }) => [{ t: "text", v: `Telefone — ${name}` }],
            () => [{ t: "text", v: `Confirmar por telefone` }],
            () => [{ t: "text", v: `Ligar e confirmar detalhes` }],
            ({ name }) => [{ t: "text", v: `Falar com ${name}` }],
        ],
    },
    ...
    SERVICE_PRICING: {
        ...
        "service.ctaPhone": [
            ({ name }) => [{ t: "text", v: `Ligar para ${name}` }],
            ({ name }) => [{ t: "text", v: `Telefone — ${name}` }],
            () => [{ t: "text", v: "Ligar e pedir orçamento" }],
            () => [{ t: "text", v: "Falar por telefone" }],
