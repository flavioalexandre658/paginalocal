...
export function ContactButton({
  ...
  const variantStyles = {
    hero: type === 'whatsapp'
      ? 'inline-flex items-center gap-3 rounded-2xl bg-gradient-to-r from-emerald-600 to-emerald-700 px-6 py-3.5 text-base font-semibold text-white shadow-xl shadow-emerald-600/25 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-emerald-600/30 sm:px-8 sm:py-4 sm:text-lg'
    ...
    floating: 'group flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-emerald-600 to-emerald-700 text-white shadow-lg shadow-emerald-600/30 transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-emerald-600/40',
