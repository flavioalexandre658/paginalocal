    ...
    <div className="relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            <div className="flex gap-2 shrink-0">
              <button
                ...
                style={{
                  border: isDark ? "1px solid rgba(255,255,255,0.1)" : `1px solid ${tokens.palette.text}15`,
                  color: isDark ? "rgba(255,255,255,0.5)" : tokens.palette.textMuted,
                  borderRadius: "var(--btn-radius, 50%)",
        ...
        <div className="relative">
          <div
            ref={scrollRef}
            className="flex gap-3 md:gap-6 overflow-x-auto pb-4 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden"
            style={{ scrollbarWidth: "none" }}
          >
            {c.categories.map((category, index) => (
              <div
                key={index}
                className="pgl-fade-up snap-center shrink-0 min-w-[260px] md:min-w-[300px] w-72 md:w-80 overflow-hidden group"
