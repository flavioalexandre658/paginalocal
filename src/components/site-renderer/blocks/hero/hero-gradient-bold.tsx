      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
        <div className="max-w-4xl mx-auto py-6 md:py-10">
          ...
          <StyledHeadline
            ...
            tokens={tokens}
            as="h1"
            className="pgl-fade-up leading-[1.1] text-white text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl"
            accentClassName={cn(
          ...
          <p
            className={cn(
              "pgl-fade-up mt-6 text-base md:text-lg leading-[1.6] max-w-xl mx-auto font-light",
              isElegant
                ? "text-white/85"
                : isWarm
                  ? "text-white/70"
