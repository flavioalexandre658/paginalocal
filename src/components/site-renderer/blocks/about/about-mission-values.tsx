...
export function AboutMissionValues({ content, tokens }: Props) {
  ...
  const lineLabelBg = selfDark ? "rgba(255,255,255,0.08)" : `${tokens.palette.text}14`;
  const highlightLabelColor = selfDark ? "rgba(255,255,255,0.3)" : tokens.palette.textMuted;
  const highlightBorderColor = selfDark
    ? "rgba(255,255,255,0.06)"
    : `${tokens.palette.text}0a`;
  const highlightBorderHover = selfDark
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-10 md:mb-16">
          {/* Label */}
          <div className="pgl-fade-up flex items-center justify-center gap-3 mb-5">
            <span
              className="w-10 h-px"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 lg:gap-16 items-center">
          {/* Image */}
          {c.image && (
            <div className="pgl-fade-left" data-delay="2">
              <ImageFrame
                src={c.image}
          ...
          {/* Text content */}
          <div className={cn(!c.image && "lg:col-span-2 max-w-2xl mx-auto")}>
            ...
            >
              {/* Paragraphs */}
              <div className="space-y-4 pgl-fade-up" data-delay="2">
            ...
            {/* Highlights as value cards */}
            {c.highlights && c.highlights.length > 0 && (
              <div
                className="pgl-fade-up grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-8 md:mt-10 pt-6 md:pt-8"
              ...
              >
                {c.highlights.map((h, i) => (
                  <div
                    ...
                    onMouseOver={(e) =>
                      (e.currentTarget.style.borderColor = highlightBorderHover)
                    }
                    onMouseOut={(e) =>
