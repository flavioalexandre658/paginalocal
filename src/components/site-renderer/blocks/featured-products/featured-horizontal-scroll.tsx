...
export function FeaturedHorizontalScroll({ content, tokens, isDark }: Props) {
  ...
  return (
    <div className="relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Horizontal scroll */}
        <div
          className="flex gap-3 md:gap-6 overflow-x-auto pb-4 [&::-webkit-scrollbar]:hidden"
          style={{ scrollbarWidth: "none" }}
        >
          {c.items.map((item, index) => (
            <div
              key={index}
              className="pgl-fade-up shrink-0 min-w-[260px] md:min-w-[300px] w-64 md:w-72 overflow-hidden group"
